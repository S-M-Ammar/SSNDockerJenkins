...
let alert_model = require('../models/live_alerts_model')
...
io.on("connection",(socket)=>{
                ...
                if(params.node_id==result.mac){
                    if(result.sensor_number==1){
                        try{
                            ...
                            console.log(e)
                            console.log("Cant send data for machine with socket.io -1 mqtt")
                        }
                        ...
                        try{
                            ...
                            console.log(e)
                            console.log("Cant send data for machine with socket.io -2 mqtt")
                        }
                ...
                if(mac_list.length>=1){
                    ...
                    if(mac_list.includes(params.node_id)){
                        ...
                        try{
                            ...
                            console.log(e)
                            console.log("Cant send data for zone with socket.io -mqtt")
                        }
    ...
    socket.on('send-data-alert',(protocol)=>{
        client.on('message',async (topic,msg)=>{
            zone_mapping_service.get_environment_data_for_zone(protocol._id).then(async (mac_list)=>{
                ...
                if(mac_list.length>=1){
                    ...
                    if(mac_list.includes(params.node_id)){
                        ...
                        try{
                            ...
                            console.log(e)
                            console.log("Cant send data for alerts with socket.io -mqtt")
                        }
